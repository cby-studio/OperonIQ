    ...
    <div className="flex h-full flex-col">
      ...
      <div className="min-h-0 flex-1" style={{ minHeight: 380 }}>
        ...
        >
          ...
          {/* 01 People — cx=170, cy=62 */}
          <rect x="118" y="37" width="104" height="45" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          ...
          {/* 02 Process — cx=270, cy=118 */}
          <rect x="218" y="93" width="104" height="45" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          ...
          {/* 03 Data — cx=295, cy=243 */}
          <rect x="232" y="218" width="104" height="45" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          ...
          {/* 04 Applications — cx=225, cy=343 — shifted right to clear Automation */}
          <rect x="173" y="318" width="116" height="50" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          <text x="185" y="334" fontSize="9" fill="#2E4668">04</text>
          <text x="231" y="352" fontSize="11" fontWeight="500" fill="#C8D6EE" textAnchor="middle">Applications</text>

          {/* 05 Automation — cx=115, cy=343 */}
          <rect x="55" y="318" width="116" height="50" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          <text x="67" y="334" fontSize="9" fill="#2E4668">05</text>
          <text x="113" y="352" fontSize="11" fontWeight="500" fill="#C8D6EE" textAnchor="middle">Automation</text>

          {/* 06 AI Agents — cx=45, cy=243 */}
          <rect x="0" y="218" width="104" height="45" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          <text x="12" y="234" fontSize="9" fill="#2E4668">06</text>
          <text x="52" y="252" fontSize="12" fontWeight="500" fill="#C8D6EE" textAnchor="middle">AI Agents</text>

          {/* 07 Governance — cx=70, cy=118 */}
          <rect x="14" y="93" width="104" height="45" rx="8" fill="#0F1B2E" stroke="#1E3252" strokeWidth="0.8" />
          ...
          {/* Intelligence Layer core — centred at (170, 210) */}
